...
import { Wishlist, wishlistReducer } from "./reducers/wishlist.reducer";
...
//we have 4 reducers, the settings reducer uses "effect" technique because settings are returned from  a service
